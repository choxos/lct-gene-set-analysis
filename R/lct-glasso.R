...
#' @param rho Penalty parameter for graphical lasso. Default is 0.4. Higher
...
#' }
#'
#' **Performance**: ~4-8 seconds per gene set (with 1000 permutations) - slowest method
#'
#' **When to use**: Network analysis, sparse gene interactions, pathway analysis
#'
#' @note
